...
ALGORITHM_ID = "granular_and_modulation.envelope_followed_modulation_routing"
ALGORITHM_NAME = "Envelope-followed modulation routing"
THEME = "Granular and Modulation"


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Envelope-followed modulation routing on the provided audio buffer.
