...
ALGORITHM_ID = "creative_spectral_effects.resonator_filterbank_morphing"
ALGORITHM_NAME = "Resonator/filterbank morphing"
THEME = "Creative Spectral Effects"


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Resonator/filterbank morphing on the provided audio buffer.
