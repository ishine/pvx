...
ALGORITHM_ID = "creative_spectral_effects.phase_randomization_textures"
ALGORITHM_NAME = "Phase randomization textures"
THEME = "Creative Spectral Effects"


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Phase randomization textures on the provided audio buffer.
