...
ALGORITHM_ID = "spatial_and_multichannel.coherence_based_dereverb_multichannel"
ALGORITHM_NAME = "Coherence-based dereverb (multichannel)"
THEME = "Spatial and Multichannel"


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Coherence-based dereverb (multichannel) on the provided audio buffer.
