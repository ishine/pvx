...
ALGORITHM_ID = "spatial_and_multichannel.multichannel_noise_psd_tracking"
ALGORITHM_NAME = "Multichannel noise PSD tracking"
THEME = "Spatial and Multichannel"


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Multichannel noise PSD tracking on the provided audio buffer.
