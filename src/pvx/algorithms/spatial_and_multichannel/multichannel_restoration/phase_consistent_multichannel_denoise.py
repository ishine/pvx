...
ALGORITHM_ID = 'spatial_and_multichannel.phase_consistent_multichannel_denoise'
ALGORITHM_NAME = 'Phase-consistent multichannel denoise'
THEME = 'Spatial and Multichannel'


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Phase-consistent multichannel denoise on the provided audio buffer.
