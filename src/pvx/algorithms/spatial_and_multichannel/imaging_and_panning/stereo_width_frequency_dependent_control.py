...
ALGORITHM_ID = "spatial_and_multichannel.stereo_width_frequency_dependent_control"
ALGORITHM_NAME = "Stereo width (frequency-dependent control)"
THEME = "Spatial and Multichannel"


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Stereo width (frequency-dependent control) on the provided audio buffer.
