...
ALGORITHM_ID = 'spatial_and_multichannel.dbap_distance_based_amplitude_panning'
ALGORITHM_NAME = 'DBAP (distance-based amplitude panning)'
THEME = 'Spatial and Multichannel'


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run DBAP (distance-based amplitude panning) on the provided audio buffer.
