...
ALGORITHM_ID = "spatial_and_multichannel.pvx_spatial_transient_preservation"
ALGORITHM_NAME = "pvx spatial transient preservation"
THEME = "Spatial and Multichannel"


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run pvx spatial transient preservation on the provided audio buffer.
