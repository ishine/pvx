...
ALGORITHM_ID = "spatial_and_multichannel.rotating_speaker_doppler_field"
ALGORITHM_NAME = "Rotating-speaker Doppler field"
THEME = "Spatial and Multichannel"


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Rotating-speaker Doppler field on the provided audio buffer.
