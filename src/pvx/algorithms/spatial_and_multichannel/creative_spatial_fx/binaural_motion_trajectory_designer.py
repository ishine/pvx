...
ALGORITHM_ID = 'spatial_and_multichannel.binaural_motion_trajectory_designer'
ALGORITHM_NAME = 'Binaural motion trajectory designer'
THEME = 'Spatial and Multichannel'


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Binaural motion trajectory designer on the provided audio buffer.
