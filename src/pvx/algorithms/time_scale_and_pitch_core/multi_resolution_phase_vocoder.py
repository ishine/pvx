...
ALGORITHM_ID = "time_scale_and_pitch_core.multi_resolution_phase_vocoder"
ALGORITHM_NAME = "Multi-resolution phase vocoder"
THEME = "Time-Scale and Pitch Core"


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Multi-resolution phase vocoder on the provided audio buffer.
