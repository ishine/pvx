...
ALGORITHM_ID = "separation_and_decomposition.tensor_decomposition_cp_tucker"
ALGORITHM_NAME = "Tensor decomposition (CP/Tucker)"
THEME = "Separation and Decomposition"


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Tensor decomposition (CP/Tucker) on the provided audio buffer.
