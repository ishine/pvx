...
ALGORITHM_ID = 'dereverb_and_room_correction.room_impulse_inverse_filtering'
ALGORITHM_NAME = 'Room impulse inverse filtering'
THEME = 'Dereverb and Room Correction'


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Room impulse inverse filtering on the provided audio buffer.
