...
- [`tests/test_voc_window_scipy.py`](#teststestvocwindowscipypy)
...
## `tests/test_voc_window_scipy.py`

**Purpose:** No module docstring present.

**Classes:** `TestMakeWindowScipyDispatch`
**Functions:** None

**Help commands:** `python3 tests/test_voc_window_scipy.py`
