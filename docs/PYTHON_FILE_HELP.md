...
- [`tests/test_coherence.py`](#teststestcoherencepy)
...
**Purpose:** Tests for stereo coherence metrics.

**Classes:** `TestCoherence`
**Functions:** None

**Help commands:** `python3 tests/test_coherence.py`
