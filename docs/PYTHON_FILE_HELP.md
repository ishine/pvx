...
- [`tests/test_transients_core.py`](#teststesttransientscorepy)
...
## `tests/test_transients_core.py`

**Purpose:** Unit tests for core transient analysis functions.

**Classes:** `TestComputeTransientFeatures`
**Functions:** None

**Help commands:** `python3 tests/test_transients_core.py`
