...
- [`src/pvx/core/device.py`](#srcpvxcoredevicepy)
...
**Parameter docs:** see `docs/PVX_ALGORITHM_PARAMS.md`.
...
## `src/pvx/core/device.py`

**Purpose:** GPU/CUDA device abstraction and runtime configuration helpers.

**Classes:** `RuntimeConfig`
**Functions:** `_has_cupy`, `_is_cupy_array`, `_array_module`, `_to_numpy`, `_to_runtime_array`, `runtime_config`, `configure_runtime`, `configure_runtime_from_args`
