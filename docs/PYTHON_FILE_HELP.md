...
- [`src/pvx/algorithms/dynamics_and_loudness/core.py`](#srcpvxalgorithmsdynamicsandloudnesscorepy)
...
## `src/pvx/algorithms/dynamics_and_loudness/core.py`

**Purpose:** No module docstring present.

**Classes:** None
**Functions:** `envelope_follower`, `compressor`, `upward_compressor`, `true_peak_limit`, `transient_shaper`, `spectral_dynamics`, `split_bands`, `multiband_compression`, `_lufs_estimate`, `_dispatch_dynamics`
