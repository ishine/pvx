...
| `sine` | Sinusoidal | `none` | W2 | 0.636620 | 1.233700 | -2.098 | 3.000 | -22.999 | [time](assets/windows/sine_time.svg) / [freq](assets/windows/sine_freq.svg) | Smooth endpoint behavior and straightforward implementation. | Less configurable than Kaiser/Tukey families. | Use for stable, low-complexity alternatives to Hann. |
...
| `triangular` | Triangular | `none` | W4 | 0.500000 | 1.333333 | -1.824 | 4.000 | -26.523 | [time](assets/windows/triangular_time.svg) / [freq](assets/windows/triangular_freq.svg) | Cheap linear taper with intuitive behavior. | Higher sidelobes than stronger cosine-sum windows. | Use for low-cost processing or quick exploratory runs. |
...
| `cosine` | Sinusoidal | `none` | W2 | 0.636620 | 1.233700 | -2.098 | 3.000 | -22.999 | [time](assets/windows/cosine_time.svg) / [freq](assets/windows/cosine_freq.svg) | Smooth endpoint behavior and straightforward implementation. | Less configurable than Kaiser/Tukey families. | Use for stable, low-complexity alternatives to Hann. |
